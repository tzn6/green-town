...
# GREEN TOWN DELUXE — улучшенная художественная версия MVP для телефона.
...
# DELUXE: новые отдельные модели из единого художественного набора.
const BARN_TEXTURE: Texture2D = preload("res://assets/deluxe/barn.png")
const HOUSE_TEXTURE: Texture2D = preload("res://assets/deluxe/house.png")
const BAKERY_TEXTURE: Texture2D = preload("res://assets/deluxe/bakery.png")
const SILO_TEXTURE: Texture2D = preload("res://assets/deluxe/silo.png")
const CHICKEN_TEXTURE: Texture2D = preload("res://assets/deluxe/chicken_coop.png")
const MARKET_TEXTURE: Texture2D = preload("res://assets/deluxe/market.png")

const FIELD_EMPTY_TEXTURE: Texture2D = preload("res://assets/deluxe/field_empty.png")
const FIELD_WHEAT_TEXTURE: Texture2D = preload("res://assets/deluxe/field_wheat.png")
const FIELD_CORN_TEXTURE: Texture2D = preload("res://assets/deluxe/field_corn.png")
const FIELD_TOMATO_TEXTURE: Texture2D = preload("res://assets/deluxe/field_tomato.png")
const FIELD_CARROT_TEXTURE: Texture2D = preload("res://assets/deluxe/field_carrot.png")

const TREE_APPLE_TEXTURE: Texture2D = preload("res://assets/deluxe/apple_tree_1.png")
const TREE_APPLE_2_TEXTURE: Texture2D = preload("res://assets/deluxe/apple_tree_2.png")
const TREE_APPLE_3_TEXTURE: Texture2D = preload("res://assets/deluxe/apple_tree_3.png")
const TREE_APPLE_4_TEXTURE: Texture2D = preload("res://assets/deluxe/apple_tree_4.png")
const TREE_ROUND_TEXTURE: Texture2D = preload("res://assets/deluxe/tree_round.png")
const TREE_PINE_TEXTURE: Texture2D = preload("res://assets/deluxe/tree_pine.png")
const ROCK_FENCE_TEXTURE: Texture2D = preload("res://assets/deluxe/rock_fence.png")
const FENCE_WHITE_TEXTURE: Texture2D = preload("res://assets/deluxe/fence_white.png")
const FENCE_WOOD_TEXTURE: Texture2D = preload("res://assets/deluxe/fence_wood.png")
const GATE_TEXTURE: Texture2D = preload("res://assets/deluxe/gate.png")
const MAILBOX_TEXTURE: Texture2D = preload("res://assets/deluxe/mailbox.png")
const DOCK_TEXTURE: Texture2D = preload("res://assets/deluxe/dock.png")
const POND_TEXTURE: Texture2D = preload("res://assets/deluxe/pond.png")

const NAV_FARM_TEXTURE: Texture2D = preload("res://assets/deluxe/nav_farm.png")
const NAV_BUILD_TEXTURE: Texture2D = preload("res://assets/deluxe/nav_build.png")
...
func create_top_hud(root: Control) -> void:
	...
	top.add_theme_stylebox_override("panel", make_style(Color("#075a37"), Color("#d9c27a"), 28, 4, true))
	root.add_child(top)
...
func make_resource_panel(title_text: String, dot_color: Color) -> PanelContainer:
	...
	value.add_theme_color_override("font_color", Color("#fff4b8"))
	row.add_child(value)
...
func create_task_panel(root: Control) -> void:
	...
	panel.add_theme_stylebox_override("panel", make_style(Color("#fff1cf"), Color("#c99a5b"), 22, 5, true))
...
func create_bottom_menu(root: Control) -> void:
	...
	panel.offset_top = -101.0
	panel.offset_bottom = -10.0
	panel.add_theme_stylebox_override("panel", make_style(Color("#154f31"), Color("#e7cd86"), 30, 5, true))
	root.add_child(panel)
	...
	create_nav_texture_button(row, NAV_FARM_TEXTURE, "ФЕРМА")
	create_nav_texture_button(row, NAV_BUILD_TEXTURE, "СТРОИТЬ")
	create_nav_texture_button(row, NAV_BARN_TEXTURE, "АМБАР")
	create_nav_texture_button(row, NAV_ORDERS_TEXTURE, "ЗАКАЗЫ")
	create_nav_texture_button(row, NAV_MAP_TEXTURE, "КАРТА")


func create_nav_texture_button(parent: Control, texture: Texture2D, action: String) -> void:
	...
	button.pressed.connect(on_bottom_button_pressed.bind(action))
	parent.add_child(button)

	# Невидимая подпись нужна для доступности и поиска узлов, сама надпись уже на текстуре.
...
func create_build_dialog(parent: Control) -> PanelContainer:
	...
	create_locked_build_card(cards, CHICKEN_TEXTURE, "КУРОВНИК", "Уровень 3", "250 монет")
	create_locked_build_card(cards, MARKET_TEXTURE, "РЫНОК", "Уровень 5", "480 монет")
